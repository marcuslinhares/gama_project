  ...
  return (
    <div className="bg-surface min-h-screen pb-10">
      <header className="px-4 py-6 flex items-center gap-4 bg-white sticky top-0 z-10 shadow-sm">
        ...
        <h1 className="text-lg font-bold text-slate-900">Finalizar Pedido</h1>
      </header>

      <main className="px-4 mt-6 space-y-6">
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-surface-low">
          <h3 className="text-xs font-black uppercase text-slate-400 tracking-widest mb-4">Itens do Pedido</h3>
        ...
        <section className="space-y-4">
          <h3 className="text-xs font-black uppercase text-slate-400 tracking-widest px-1">Forma de Pagamento</h3>
              ...
              <button
                ...
                className={`flex items-center gap-4 p-4 rounded-2xl border-2 transition-all text-left ${
                  method === m.id 
                    ...
                    : 'border-white bg-white hover:border-surface-low'
                }`}
              >
      ...
      <footer className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-md border-t border-surface-low">
        <button 
